...
people.push(
  ...
  {id:'romig', name:'Harry G. Romig', years:'1898-1993', country:'Estados Unidos', stream:'Estadistica', tag:'Muestreo industrial', philosophy:'La inspeccion debe proporcionar evidencia estadistica util para decidir, con costos y riesgos controlados.', contributions:['Cocreador de las tablas Dodge-Romig.','Aportes a inspeccion por muestreo en Bell Labs.','Formacion tecnica en control de calidad.'], recognition:'Recibio la Medalla Shewhart de ASQ (1953) y fue nombrado miembro honorario de ASQ in 1982.', refs:[13], tool:'Tablas Dodge-Romig', use:'Inspeccion por lotes y aseguramiento de proveedores', year:1940},
...
$('#checkCrossword').addEventListener('click', checkCrosswordAnswers);
$('#resetCrossword').addEventListener('click', resetCrosswordBoard);
